...
QtMaterialDrawerStateMachine::QtMaterialDrawerStateMachine(
    QtMaterialDrawerWidget *drawer, QtMaterialDrawer *parent)
    : QStateMachine(parent), m_drawer(drawer), m_main(parent),
      m_openingState(new QState), m_openedState(new QState),
...
QtMaterialDrawerWidget::QtMaterialDrawerWidget(QWidget *parent)
    : QtMaterialOverlayWidget(parent), m_offset(0) {}
