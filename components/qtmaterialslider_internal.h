...
inline qreal QtMaterialSliderThumb::diameter() const { return m_diameter; }
...
inline QColor QtMaterialSliderThumb::fillColor() const { return m_fillColor; }
...
inline qreal QtMaterialSliderThumb::haloSize() const { return m_haloSize; }
...
inline QColor QtMaterialSliderThumb::haloColor() const { return m_haloColor; }
...
inline int QtMaterialSliderThumb::offset() const { return m_offset; }
...
public:
  explicit QtMaterialSliderTrack(QtMaterialSliderThumb *thumb,
...
inline QColor QtMaterialSliderTrack::fillColor() const { return m_fillColor; }
...
int QtMaterialSliderTrack::trackWidth() const { return m_trackWidth; }
