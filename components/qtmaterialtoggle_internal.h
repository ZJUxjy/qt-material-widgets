...
inline qreal QtMaterialToggleThumb::shift() const { return m_shift; }

inline qreal QtMaterialToggleThumb::offset() const { return m_offset; }
...
inline QColor QtMaterialToggleThumb::thumbColor() const { return m_thumbColor; }
...
inline QColor QtMaterialToggleTrack::trackColor() const { return m_trackColor; }
