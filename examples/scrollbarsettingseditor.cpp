...
ScrollBarSettingsEditor::ScrollBarSettingsEditor(QWidget *parent)
  ...
  edit->setText(
      "<p>The distinction between the subjects of syntax and semantics has its "
      "origin in the study of natural languages.</p><p>The distinction between "
      "the subjects of syntax and semantics has its origin in the study of "
      "natural languages.</p><p>The distinction between the subjects of syntax "
      "and semantics has its origin in the study of natural "
      "languages.</p><p>The distinction between the subjects of syntax and "
      "semantics has its origin in the study of natural languages.</p><p>The "
      "distinction between the subjects of syntax and semantics has its origin "
      "in the study of natural languages.</p><p>The distinction between the "
      "subjects of syntax and semantics has its origin in the study of natural "
      "languages.</p><p>The distinction between the subjects of syntax and "
      "semantics has its origin in the study of natural languages.</p><p>The "
      "distinction between the subjects of syntax and semantics has its origin "
      "in the study of natural languages.</p>");
