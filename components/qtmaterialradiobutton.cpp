...
void QtMaterialRadioButtonPrivate::init() {
  ...
  q->setCheckedIcon(QIcon(
      ":/icons/icons/toggle/svg/production/ic_radio_button_checked_24px.svg"));
  q->setUncheckedIcon(QIcon(":/icons/icons/toggle/svg/production/"
...
void QtMaterialRadioButton::setupProperties() {
  ...
  d->uncheckedState->assignProperty(d->uncheckedIcon, "color",
                                    uncheckedColor());
}
