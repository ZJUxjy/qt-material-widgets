...
MainWindow::MainWindow(QWidget *parent) : QMainWindow(parent) {
  ...
  FloatingActionButtonSettingsEditor *fab =
      new FloatingActionButtonSettingsEditor;
  ...
  CircularProgressSettingsEditor *circularProgress =
      new CircularProgressSettingsEditor;
