...
class QtMaterialFlatButton : public QPushButton {
  ...
  Q_PROPERTY(QColor disabledForegroundColor WRITE setDisabledForegroundColor
                 READ disabledForegroundColor)
  Q_PROPERTY(QColor disabledBackgroundColor WRITE setDisabledBackgroundColor
                 READ disabledBackgroundColor)
...
public:
  ...
  explicit QtMaterialFlatButton(
      ...
      Material::ButtonPreset preset = Material::FlatPreset);
  QtMaterialFlatButton(const QString &text, Material::Role role,
                       QWidget *parent = 0,
                       Material::ButtonPreset preset = Material::FlatPreset);
