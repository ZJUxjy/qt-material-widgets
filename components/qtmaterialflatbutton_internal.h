...
class QtMaterialFlatButtonStateMachine : public QStateMachine {
  ...
  Q_PROPERTY(
      qreal haloScaleFactor WRITE setHaloScaleFactor READ haloScaleFactor)
 ...
 private:
  ...
  void addTransition(QObject *object, QEvent::Type eventType, QState *fromState,
                     QState *toState);
  void addTransition(QAbstractTransition *transition, QState *fromState,
                     QState *toState);
