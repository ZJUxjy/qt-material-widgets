...
QtMaterialRaisedButton::QtMaterialRaisedButton(const QString &text,
                                               QWidget *parent)
    : QtMaterialFlatButton(*new QtMaterialRaisedButtonPrivate(this), parent) {
  d_func()->init();
...
QtMaterialRaisedButton::QtMaterialRaisedButton(QtMaterialRaisedButtonPrivate &d,
                                               QWidget *parent)
