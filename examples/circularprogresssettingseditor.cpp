...
CircularProgressSettingsEditor::CircularProgressSettingsEditor(QWidget *parent)
    : QWidget(parent), ui(new Ui::CircularProgressSettingsForm),
  ...
  connect(ui->progressSlider, SIGNAL(valueChanged(int)), this,
          SLOT(updateWidget()));
  connect(ui->lineWidthDoubleSpinBox, SIGNAL(valueChanged(double)), this,
          SLOT(updateWidget()));
...
CircularProgressSettingsEditor::~CircularProgressSettingsEditor() { delete ui; }
